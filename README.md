...
<summary>MySQL (RDBMS)</summary>
     MySQL은 데이터의 일관성과 복잡한 쿼리 처리가 필요한 상황에 적합하여 선택되었습니다. 
    <br><br>
    ACID 트랜잭션을 지원함으로써 데이터의 신뢰성을 보장하고, 상품 정보와 주문 데이터를 정규화된 테이블 구조로 관리하여 복잡한 비즈니스 로직을 처리할 수 있었습니다. 또한 검증된 안정성과 데이터 보존 및 백업 용이성 덕분에 핵심 데이터를 안전하게 저장하고 관리할 수 있었습니다.
</details>
